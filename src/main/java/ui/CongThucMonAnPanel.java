...
/**
 * Panel for managing food recipes
 */
public class CongThucMonAnPanel extends JPanel {
    ...
    public CongThucMonAnPanel() {
        try {
            congThucMonAnDao = CongThucMonAnDao.getInstance();
    ...
    private void addCongThucMonAn() {
        try {
            ...
            // Convert khối lượng to BigDecimal
            ...
            // Create a new CongThucMonAnEntity
    ...
    private void editCongThucMonAn() {
        ...
        try {
            ...
            // Create an updated CongThucMonAnEntity
            CongThucMonAnEntity congThuc = new CongThucMonAnEntity(
                id,
                selectedMonAn.id(),
                selectedNguyenLieu.id(),
